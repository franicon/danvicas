    ...
    <table width="100%"
        ...
        <tr>
            <td style="padding: 20px 20px 15px;background: #fff;">
                <table width="100%">
                    <tr>
                        <td style="text-align: center;">
                            <p style="font-weight: 600; font-size: 20px; line-height: 25px;">Contact Mail</p>
                        </td>
                    </tr>
                </table>
                <table width="100%" style="font-size: 11px;line-height: 18px;">
                    <tr>
                        <td>
                            ...
                            <p>I am contacting you for the following: .</p>
                        </td>
                    </tr>
                </table>
                <!-- LISTED ITEMS -->
                        ...
                        <td>
                            ...
                            <table style="width: 60%;min-width: 320px;border-spacing: 0 10px;">
                                <tr>
                                    ...
                                    <td style="text-align: right;">{{$mailData['name']}}</td>
                                </tr>
                                <tr>
                ...
                <table width="100%" style="font-size: 11px;line-height: 18px;">
                    <tr>
                        <p style="font-weight: 500; font-size: 11px;">Message:</p>
                        <td style="text-align: justify;">{{$mailData['message']}}</td>
                    </tr>
                </table>
                <table width="100%" style="font-size: 11px;line-height: 18px;">
                    <tr>
