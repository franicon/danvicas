...
@section('content')
    <div class=" mx-auto">
        <section class="container tw-py-10">
            <form class="row justify-content-center g-3 mt-5" method="POST" action="/admin/insights/{{ $service->id }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="col-12">
                    <h3 class="tw-font-bold">Edit Insight: {{$service->title}} </h3>
                </div>
                <hr>
                <div class="col-md-2">
                    ...
                    <div class="px-3">
                        ...
                        <div class="tw-flex tw-items-center mb-4">
                            <div class="input-group mb-4">
                                ...
                                <input type="file" name="thumbnail" value=" {{$service->image}}" class="form-control" id="inputGroupFile01">
                            </div>
                        ...
                        <div class="form-floating mb-4">
                            <input type="text"  value="{{$service->title}}" name="slug" required class="form-control" id="slug" placeholder="slug">
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <label for="first_body">Description</label>
                            @error('body')
                            <p class="text-danger tw-py-4">{{$message}}</p>
                            @enderror
                        </div>
