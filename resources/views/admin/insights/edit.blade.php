                    ...
                    <div class="px-3">
                        ...
                        <div class="tw-flex tw-items-center mb-4">
                            <div class="input-group mb-4">
                                ...
                                <input type="file" name="thumbnail" value=" {{$insight->image}}" class="form-control" id="inputGroupFile01">
                            </div>
                            <div class="col-2 rounded">
                                <div class="px-2 ">
                                    <img src="/storage/{{$insight->image}}" alt="" class="tw-rounded-3xl">
                                </div>
                            </div>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text"  value="{{$insight->title}}" name="slug" required class="form-control" id="slug" placeholder="slug">
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <label for="first_body">Insight Body 1</label>
                            @error('first_body')
                            <p class="text-danger tw-py-4">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-floating mb-4">
                            ...
                            <label for="second_body">Description</label>
                            @error('second_body')
                            <p class="text-danger tw-py-4">{{$message}}</p>
                            @enderror
                        </div>
